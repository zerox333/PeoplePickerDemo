...
{
    APContact *copy = [[[self class] allocWithZone:zone] init];
    copy.fieldMask = _fieldMask;
    copy.firstName = _firstName;
    copy.middleName = _middleName;
    copy.lastName = _lastName;
    copy.compositeName = _compositeName;
    copy.company = _company;
    copy.phones = _phones;
    copy.phonesWithLabels = _phonesWithLabels;
    copy.emails = _emails;
    copy.addresses = _addresses;
    copy.photo = _photo;
    copy.thumbnail = _thumbnail;
    copy.recordID = _recordID;
    copy.creationDate = _creationDate;
    copy.modificationDate = _modificationDate;
    copy.socialProfiles = _socialProfiles;
    copy.note = _note;
    return copy;
}
